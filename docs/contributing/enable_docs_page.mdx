...
The AGENTS.md file stays on GitHub, while the FAQs (DESIGN_FAQ, DX_FAQ) are served directly on the documentation site; link them from MDX when agents or humans need them (see [docs map](../start_here/docs_map)).
...
- [DX_FAQ](../DX_FAQ) — contributor commands
