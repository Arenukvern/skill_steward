...
Repo-root FAQs (`DESIGN_FAQ.md`, `DX_FAQ.md`) and `AGENTS.md` stay on GitHub; link them from MDX when agents or humans need them (see [docs map](/start_here/docs_map)).
...
- [ADR 0005 — Executable plans and docs.page](/decisions/0005-executable-plans-and-docs-page)
