...
* Bad, because hook install is a second step on Cursor until plugin installers land — see [ADR 0004](0004-plugin-packaging-and-install-path.mdx).
...
* Follow-up delivered in [ADR 0004](0004-plugin-packaging-and-install-path.mdx) (`plugins/` layout and install paths).
...
* Related: [ADR 0000](0000-use-markdown-architectural-decision-records.mdx)
