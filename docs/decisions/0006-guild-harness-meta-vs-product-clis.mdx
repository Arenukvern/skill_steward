...
The open skills ecosystem has **product harnesses** with real CLIs and MCP servers (e.g. product-level CLI toolkits and schema libraries). Skill Steward is a **meta-layer** ([ADR 0001](0001-repository-purpose-as-skills-meta-layer.mdx)) teaching how to build and document harnesses—not replacing product tools.
...
- Docs map, North Star, plan hygiene doctrine ([ADR 0005](0005-executable-plans-and-docs-page.mdx))
- FAQ / ADR discipline
...
* Neutral, because meta MCP is deferred to phase 2 ([ADR 0007](0007-dart-for-guild-cli-and-harness-tooling.mdx)).
