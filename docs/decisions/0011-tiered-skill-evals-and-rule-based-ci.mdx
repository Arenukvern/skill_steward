...
* **Charter risk** — Tier-1 skills (`mcp-harness-repo-maintainer`, `skill-authoring-lifecycle`) need stronger gates than utility skills.
...
|------|--------|----------------------|----------------------|
| **1 — Behavioral** | `mcp-harness-repo-maintainer`, `skill-authoring-lifecycle` | ≥2 `evals/cases/*.yaml`; schema + static rules | `references/evals.md`, held-out prompts, plugin-eval, SkillOpt loop |
