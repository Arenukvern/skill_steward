...
* **Charter risk** — Tier-1 skills (`north-star-governance`, `skill-authoring-lifecycle`, …) need stronger gates than utility skills.
...
|------|--------|----------------------|----------------------|
| **1 — Behavioral** | `north-star-governance`, `mcp-harness-repo-maintainer`, `mcp-harness-repo-maintainer`, `skill-authoring-lifecycle` | ≥2 `evals/cases/*.yaml`; schema + static rules | `references/evals.md`, held-out prompts, plugin-eval, SkillOpt loop |
