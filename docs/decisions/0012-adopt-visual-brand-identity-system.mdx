...
* [Brand reference SSOT](../brand.mdx) (to be created in the same change set)
* [ADR 0008 — Skill Steward name (stewardship, ethics, governance)](0008-adopt-skill-steward-product-name.mdx)
* [NORTH_STAR.mdx](../NORTH_STAR.mdx) — plan hygiene, meta-layer boundaries, "repo stays small"
* [DESIGN_FAQ.mdx](../DESIGN_FAQ.mdx) — restraint and care as features
