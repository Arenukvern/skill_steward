...
Skill Steward’s charter ([ADR 0001](0001-repository-purpose-as-skills-meta-layer.mdx)) is a meta-layer for **managing skills and improving processes**. Documentation format is part of that process surface—not domain recipes.
...
* Strategic alignment cited in [ADR 0001](0001-repository-purpose-as-skills-meta-layer.mdx) documentation practices.
...
* **Related ADR:** [0001 — repository purpose](0001-repository-purpose-as-skills-meta-layer.mdx)
