...
Skill Steward’s charter ([ADR 0001](0001-repository-purpose-as-skills-meta-layer)) is an Engineering Stewardship layer for **agent-operated repositories and their quality systems**. Documentation format is part of that process surface—not domain recipes.
