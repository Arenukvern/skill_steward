...
Maintainer practice also uses [FAQ-driven development](https://dev.to/arenukvern/faq-driven-development-or-new-old-way-to-write-docs-rules-prompts-25jl) for compressed Q&A at package level ([ADR 0002](0002-adopt-faq-driven-documentation.mdx)).
...
* **Related:** [ADR 0002 — FAQ-driven documentation](0002-adopt-faq-driven-documentation.mdx)
