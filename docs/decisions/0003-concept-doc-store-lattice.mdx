...
* **Reference implementation** — product harnesses analyzed and encoded in `north-star-governance` skill.
...
Chosen option: **"Layered concept doc store + optional FAQs"**, shipped as skill `north-star-governance` with reference analysis of product harnesses.
...
* Skill `skills/north-star-governance/` with lattice, SSOT, and bootstrap references.
...
* **Skill:** [skills/north-star-governance/](https://github.com/arenukvern/skill_steward/blob/main/skills/north-star-governance)
