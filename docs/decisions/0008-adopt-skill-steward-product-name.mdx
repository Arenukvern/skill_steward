...
* Good, because the name matches [ADR 0001](0001-repository-purpose-as-skills-meta-layer.mdx) intent (meta-layer) and the maintainer credo.
* Good, because it pairs naturally with sibling product harnesses in public bios and README without a third “guild” narrative.
* Neutral, because **historical** ADRs and ADR titles may still say “Agent Guild”; consumer-facing copy uses Skill Steward ([ADR 0008](0008-adopt-skill-steward-product-name.mdx)).
...
* [ADR 0001 — meta-layer purpose](0001-repository-purpose-as-skills-meta-layer.mdx)
