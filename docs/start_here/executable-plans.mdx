...
|--------------|---------|
| Strategic choice, trade-off | [ADR](../decisions/README.mdx) |
...
| Charter / scope change | [North Star](../NORTH_STAR.mdx) + ADR if significant |
...
1. Read [North Star](../NORTH_STAR.mdx) before multi-step work.
...
- [ADR 0005 — docs.page + ephemeral plans doctrine](../decisions/0005-executable-plans-and-docs-page.mdx)
