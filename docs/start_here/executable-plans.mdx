...
The same instinct applies to overgrown non-plan docs: keep the canonical owner, merge or delete duplicate surfaces, and move deterministic repeated truth into checks instead of prose.
