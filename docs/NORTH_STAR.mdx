...
9. **Repository ecology reviews** — when surfaces accumulate, run a disposition pass over plans, specs, docs, skills, schemas, tools, evidence, and validation gates. The outcome may be compression, deletion, a check, an ADR, or no change.
10. **Evidence retention** — keep proof artifacts only when they protect a claim, preserve a blocker, record a real run, or shorten future work. Current truth belongs in ledgers; repeated deterministic truth should become checks or tools.
