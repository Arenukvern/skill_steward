...
- **Ethical governance model** — use [`ethical-stewardship`](https://github.com/arenukvern/skill_steward/blob/main/skills/ethical-stewardship/SKILL.md) to bootstrap, audit, and refine the credo and design constraints for this repo.
...
- [Skill: ethical-stewardship](https://github.com/arenukvern/skill_steward/blob/main/skills/ethical-stewardship/SKILL.md) — governance model (Anti-Bloat, Reversibility, Legibility, Behavior-as-Truth, Artisan Restraint)
