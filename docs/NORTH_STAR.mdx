...
| Knowledge | FAQ split, docs maps, concept docs, source citations, durable provenance, public-story disclosure | Active: docs lattice + `skill-source-citations` + `storytelling-ethics-lifecycle` |
