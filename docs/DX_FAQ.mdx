...
**Authoring skill:** use installed `create-skill` or read `../skills/create-skill/SKILL.md`.
...
CLI+MCP dual surface    → ../skills/harness-engineering-culture/references/cli-mcp-pattern.md (product MCP / platform libs)
