...
| `mcp-harness-repo-maintainer` | CLI/MCP harness culture |
...
| `skill-authoring-lifecycle` / `skill-authoring-lifecycle` | Author and audit `plugin/skills/` |
...
After Skill Steward merges to `main`, consumers refresh installed `SKILL.md` files with [vercel-labs/skills](https://github.com/vercel-labs/skills) (`npx skills`). Installed paths depend on agent (e.g. `.cursor/skills/`, `.agents/skills/`); see [AGENTS.md](https://github.com/arenukvern/skill_steward/blob/main/AGENTS.md).
...
| Repo lattice (router, SSOT) | `north-star-governance` |
