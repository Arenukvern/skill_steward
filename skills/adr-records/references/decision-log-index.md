...
Maintain `docs/decisions/README.md` (or the folder’s `README.md`) as the **single index** of all ADRs.
...
|-----|--------|-------|------|
| [0000](0000-use-markdown-architectural-decision-records.md) | accepted | Use Markdown ADRs | 2026-01-15 |
| [0001](0001-use-postgresql.md) | accepted | Use PostgreSQL for persistence | 2026-05-29 |
```

## Bootstrap `0000` ADR

Many repos start with a meta-ADR documenting that the project uses ADRs (see [adr/madr example 0000](https://github.com/adr/madr/blob/develop/template/0000-use-markdown-architectural-decision-records.md)).
