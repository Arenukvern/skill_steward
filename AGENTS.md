...
This project is indexed by GitNexus as **skill_steward** (2996 symbols, 5551 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
