...
This project is indexed by GitNexus as **skill_steward** (2890 symbols, 5298 relationships, 233 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
