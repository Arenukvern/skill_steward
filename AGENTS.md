...
This project is indexed by GitNexus as **skill_steward** (2920 symbols, 5338 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
