...
- c13457b: Document binary release contract (mcp_flutter pattern); ADR 0010 defers binaries for Skill Steward.
...
- efe245c: Align harness skill docs with IntentCall product naming (github.com/Arenukvern/intentcall).
